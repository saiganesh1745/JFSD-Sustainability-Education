...
//   const currentUser = JSON.parse(localStorage.getItem('userDetails')); // Get user details

//   useEffect(() => {
//     const fetchLessons = async () => {
//       try {
//         const response = await axios.get('http://localhost:8080/admin/lessons'); // Adjust endpoint if needed
